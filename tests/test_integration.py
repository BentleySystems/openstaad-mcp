"""Integration tests - require running STAAD.Pro instance."""
...
class TestPerformance:
    ...
    def test_host_call_latency(self, staad_instance, executor):
        ...
        # reasonable dev box. Initial benchmarks showed ~180 µs / call, so
        # ~18 ms of actual host-call time; the rest is plugin instantiation.
